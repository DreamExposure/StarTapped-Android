...
public class AddBookmarkTask extends AsyncTask<Object, Void, NetworkCallStatus> {
    private TaskCallback callback;
    private UUID postId;

    public AddBookmarkTask(TaskCallback _callback, UUID _postId) {
        callback = _callback;
        postId = _postId;
    }
    ...
    protected NetworkCallStatus doInBackground(Object... objects) {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url(GlobalConst.apiUrl + "/post/bookmark/add")
                    .post(requestBody)
            ...
            if (response.code() == 200) {
                //Success
                return new NetworkCallStatus(true, TaskType.BOOKMARK_ADD)
                ...
                return new NetworkCallStatus(false, TaskType.BOOKMARK_ADD)
                        .setCode(response.code())
                        .setMessage(responseBody.getString("message"))
                        .setBody(responseBody);
            }
