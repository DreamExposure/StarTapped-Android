...
public class GetPostsForHubTask extends AsyncTask<Object, Void, NetworkCallStatus> {
    private TaskCallback callback;
    private TimeIndex index;

    public GetPostsForHubTask(TaskCallback _callback, TimeIndex _index) {
        callback = _callback;
        index = _index;
    }
    ...
    protected NetworkCallStatus doInBackground(Object... objects) {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url(GlobalConst.apiUrl + "/post/get/hub")
                    .post(requestBody)
            ...
            if (response.code() == 200) {
                //Success
                return new NetworkCallStatus(true, TaskType.POST_GET_FOR_HUB)
                ...
                return new NetworkCallStatus(false, TaskType.POST_GET_FOR_HUB)
                        .setCode(response.code())
                        .setMessage(responseBody.getString("message"))
                        .setBody(responseBody);
            }
