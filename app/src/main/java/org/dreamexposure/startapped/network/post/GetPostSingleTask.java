...
public class GetPostSingleTask extends AsyncTask<Object, Void, NetworkCallStatus> {
    private TaskCallback callback;
    private UUID postId;

    public GetPostSingleTask(TaskCallback _callback, UUID _postId) {
        callback = _callback;
        postId = _postId;
    }
    ...
    protected NetworkCallStatus doInBackground(Object... objects) {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url(GlobalConst.apiUrl + "/post/get")
                    .post(requestBody)
            ...
            if (response.code() == 200) {
                //Success
                return new NetworkCallStatus(true, TaskType.POST_GET_SINGLE)
                ...
                return new NetworkCallStatus(false, TaskType.POST_GET_SINGLE)
                        .setCode(response.code())
                        .setMessage(responseBody.getString("message"))
                        .setBody(responseBody);
            }
